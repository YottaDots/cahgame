...
//                    //only when the cells are within the range of the block.
//                    if ($iColumn >= $CardDeck[$c]['columnr'] && isset($CardDeck[$c]['maxcolumnr']) && ($iColumn <= $CardDeck[$c]['columnr'] + $CardDeck[$c]['maxcolumnr']) && $iRow != $CardDeck[$c]['rownr'] && $CardDeck[$c]['maxrownr'] <=$iRow ) {
////                        if (!empty($cell->getValue())) {
